...
var addButton=document.querySelector(".add-tasks__button");//first button
var incompleteTaskHolder=document.querySelector(".todo-tasks__list");//ul of .todo-tasks
...
var createNewTaskElement=function(taskString){
    ...
    editButton.className="button button_type_edit task-item__button";

    deleteButton.className="button button_type_delete task-item__button";
